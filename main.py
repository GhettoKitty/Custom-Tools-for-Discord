"""
THIS IS JUST THE SCRIPT THAT IS USED TO MAKE IT WORK
IF YOU WANT TO RUN THE DISCORD UTILITY TOOL
REFER TO THE RELEASE NOTES AND DOWNLOAD THE "discordtools" FOR THE UTILITY TOOLS
